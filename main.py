...
file_path = os.path.join(image_output_dir, 'std_out')
...
print(f"System CAGR: {system_metrics[0].values[0]*100:.1f}%")
print(f"System Sharpe: {system_metrics[1]:.1f}")

print(f"Market CAGR: {market_metrics[0].values[0]*100:.1f}%")
